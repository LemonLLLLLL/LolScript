                        ...
                        if (heroManager != IntPtr.Zero)
                        {
                            for (uint i = 0; i <= 12; i++)
                            {
                                ...
                                if (heroPtr != IntPtr.Zero)
                                {
                                    ...
                                    if((heroData.oObjVisibility == 1)) Console.WriteLine("#1");
                                    if((heroData.oObjTeam == 100 || heroData.oObjTeam == 200)) Console.WriteLine("#2");
                                    if((heroData.oObjHealth > 0.1) && (heroData.oObjHealth < 10000)) Console.WriteLine("#3");
                                    if(heroData.oObjMaxHealth > 99) Console.WriteLine("#4");
                                    else Console.WriteLine("#5");
                                    if(heroData.oObjArmor > 0) && (heroData.oObjArmor < 1000) Console.WriteLine("#6");
                                    if(!(heroData.oObjPos.Y != 0.0f) && (heroData.oObjPos.X != 0.0f) && (heroData.oObjPos.Z != 0.0f)) Console.WriteLine("#7");
